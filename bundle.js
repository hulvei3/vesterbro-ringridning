...
/***/ function(module, exports, __webpack_require__) {
	...
	var fb = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pages = __webpack_require__(158);
	...
	var app = React.createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			window.addEventListener("hashchange", function (e) {
				...
				_this.setState({
					pageComponent: pages[hash.substring(1)] || React.createClass({ render: function render() {
		...
		render: function render() {
			...
			return React.createElement('div', null, React.createElement('div', { id: 'fb-root' }), React.createElement('div', { id: 'banner' }), React.createElement('div', { id: 'page' }, React.createElement('hr', null), React.createElement('a', { href: '#home' }, React.createElement('h1', { id: 'headline' }, 'Vesterbro Ringridning')), React.createElement('div', { className: 'nav' }, React.createElement('ul', null, React.createElement('li', null, React.createElement('a', { href: '#pictures' }, ' Billeder')), React.createElement('li', null, React.createElement('a', { href: '#press' }, '  Presse')), React.createElement('li', null, React.createElement('a', { href: '#sponsors' }, ' Sponsorer')), React.createElement('li', null, React.createElement('a', { href: '#about' }, '  Bestyrelsen')), React.createElement('li', null, React.createElement('a', { href: '#contact' }, '  Kontakt')))), React.createElement('div', { className: 'content' }, React.createElement(CurrentPage, null)), React.createElement('footer', null, React.createElement('hr', null), '© Vesterbro Ringridning est. 2013 | CVR: 35575006')), React.createElement('div', { className: 'fb-container' }, React.createElement('div', { className: 'fb-page', 'data-href': 'https://www.facebook.com/vesterbro-ringridning', 'data-height': '800', 'data-small-header': 'false', 'data-adapt-container-width': 'true', 'data-hide-cover': 'false', 'data-show-facepile': 'true', 'data-show-posts': 'true' }, React.createElement('div', { className: 'fb-xfbml-parse-ignore' }, React.createElement('blockquote', { cite: 'https://www.facebook.com/vesterbro-ringridning' }, React.createElement('a', { href: 'https://www.facebook.com/vesterbro-ringridning' }, 'Vesterbro Ringridning'))))));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		home: __webpack_require__(159),
		about: __webpack_require__(160),
		pictures: __webpack_require__(161),
		contact: __webpack_require__(164),
		press: __webpack_require__(165),
		sponsors: __webpack_require__(166)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var home = React.createClass({ displayName: 'Page.home',
		...
		render: function render() {
			return React.createElement('div', null, React.createElement('p', null, 'Vesterbro Ringridning er en frivillig forening, hvis formål bl.a. er at afholde et årligt tilbagevendende (cykel)ringrider arrangement på Vesterbro i København. Foreningen blev grundlagt i 2013 og er sidenhen blevet en fast del af Vesterbros mange kulturelle arrangementer.'), React.createElement('p', null, 'Ringridning er først og fremmest en gammel sønderjysk tradition. En sport, hvor man rider på heste og fanger ringe, der hænger fra galger med hjælp af en lanse. Sporten har rødder i gamle ridderturneringer fra middelalderen, og er en fast del af enhver sønderjysk by - stor og lille. Vinderne, en konge og en dronning kåres ved optælling af ringe.'), React.createElement('p', null, 'Cykelringridning er ligesom ringridning også en gammel tradition under samme koncept, bare på cykel. Her er ikke mindst også udsmykning af cyklerne en stor del af konkurrencen.'));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var about = React.createClass({ displayName: 'Page.about',
		...
		render: function render() {
			return React.createElement('div', null, React.createElement('p', null, 'Vesterbro Ringridnings bestyrelse består af sønderjyske ildsjæle med et glimt i øjet.'), React.createElement('img', { src: 'media/people.jpg', style: { width: '100%' } }), React.createElement('ul', null, React.createElement('li', null, 'Jakob Jakobsen Boysen'), 'Opvokset ved Nordborg. Jakob er uddannet softwareingeniør fra Danmarks Tekniske Universitet 2014, og arbejder ved Novo Nordisk.', React.createElement('li', null, 'Sara Stricker'), 'Opvokset i Bovrup. Sara studerer til sygeplejeske på Diakonissestiftelsens Sygeplejeskole, og er i sin sidste praktik på retspsykiatrisk afdeling på Sankt Hans Hospital.', React.createElement('li', null, 'Christian Michelsen'), 'Fra Lysabild på Als. Christian er i øjeblikket i gang med at færdiggøre sin ingeniøruddannelse i mekanik og konstruktion på Danmarks Tekniske Universitet.', React.createElement('li', null, 'Philip Hansen Frank'), 'Opvokset i Dybbøl. Philip studerer informationsvidenskab og kulturformidling på Københavns Universitet, og som studiejob arbejder han på Rigshospitalets arkiv.', React.createElement('li', null, 'Anne Zachariassen'), 'Opvokset på Vestermarken tæt på Felsted. Netop færdig med sin kandidat i Global Studies på Roskilde Universitet, og bor for tiden i Geneve.', React.createElement('li', null, 'Morten Hulvej Andersen'), 'Opvokset i Dyndved på Als. Morten er uddannet softwareingeniør fra Danmarks Tekniske Universitet 2013, og arbejder som ved e-conomic International.'));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ImageGallery = __webpack_require__(162);
	
	var imgs = ['media/2013/1.jpg', 'media/2013/2.jpg', 'media/2013/3.jpg', 'media/2013/4.jpg', 'media/2013/5.jpg', 'media/2013/6.jpg', 'media/2013/7.jpg', 'media/2014/1.jpg', 'media/2014/2.jpg', 'media/2014/3.jpg'];
	...
	var pictures = React.createClass({ displayName: 'Page.pictures',
		...
		render: function render() {
			return React.createElement('div', { className: 'img-gallery' }, React.createElement(ImageGallery, {
				items: images,
				autoPlay: false,
				slideInterval: 3000
			}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSwipeable = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var contact = React.createClass({ displayName: 'Page.contact',
		...
		render: function render() {
			return React.createElement('div', null, React.createElement('div', null, React.createElement('b', null, 'Vesterbro Ringridning'), React.createElement('br', null), 'c/o Morten Hulvej Andersen', React.createElement('br', null), 'Reverdilsgade 7, 1.th.', React.createElement('br', null), '1701 København V'), 'CVR: 35575006', React.createElement('h4', null, 'Facebook'), React.createElement('span', null, React.createElement('a', { href: 'https://www.facebook.com/VesterbroRingridning', target: '_blank' }, 'https://www.facebook.com/VesterbroRingridning')), React.createElement('h4', null, 'Instagram'), React.createElement('span', null, React.createElement('a', { href: 'https://instagram.com/vesterbroringridning', target: '_blank' }, 'https://instagram.com/vesterbroringridning/')));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var press = React.createClass({ displayName: 'Page.press',
	
		render: function render() {
			return React.createElement('div', null, React.createElement('p', null, 'Vi har en Instagram-profil, som kan tagges i billeder fra Vesterbro Ringridning. Vores Facebook-profil kan også bruges til at nævne os i opdateringer.'));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sponsors = React.createClass({ displayName: 'Page.sponsors',
		...
		render: function render() {
			return React.createElement('div', null, React.createElement('p', null, 'Vores sponsorer er direkte medvirkende til at Vesterbro Ringridning kan blive en realitet år efter år. Vi kunne ikke gøre det uden dem!'), React.createElement('div', { className: 'sponsor-list' }, React.createElement('a', { href: 'http://www.danfoss.com/Denmark/AboutUs/Foundations/Fabrikant+Mads+Clausens+Fond/', target: '_blank' }, React.createElement('img', { src: 'img/logo-danfoss.png?1437517617488' })), React.createElement('a', { href: 'http://alsieexpress.dk/', target: '_blank' }, React.createElement('img', { src: 'img/logo-alsieexpress.png?1437517617488' })), React.createElement('a', { href: 'http://dk.ecco.com/', target: '_blank' }, React.createElement('img', { src: 'img/logo-ecco.png?1437517617488' })), React.createElement('a', { href: 'http://ronhaveslagteren.dk/', target: '_blank' }, React.createElement('img', { src: 'img/logo-roenhaveslagteren.png?1437517617488' })), React.createElement('a', { href: 'http://www.shopisyd.dk', target: '_blank' }, React.createElement('img', { src: 'img/logo-sdbghandel2.jpg?1437517617488' })), React.createElement('a', { href: 'http://www.sydbank.dk', target: '_blank' }, React.createElement('img', { src: 'img/logo-sydbank.png' }))), 'Øvrige bidragsydere', React.createElement('ul', null, React.createElement('li', null, 'Linak'), React.createElement('li', null, 'Landmand Hans Michelsen, Solbakkegaard'), React.createElement('li', null, 'Skovby Ringridning'), React.createElement('li', null, 'Birthe Andersen & Jacob Fuchs')));
		}
